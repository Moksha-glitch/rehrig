...
export const ROLE_PSG = {
  ...
  'sp:Segment Admin': 'SP Segment Admin PSG',
  'sp:Service Provider User': 'SP User PSG',
...
export const ROLE_ACCOUNT_TABS = {
  ...
  'sp:Segment Admin': ['details', 'customers', 'segments'],
  'sp:Service Provider User': ['details', 'customers', 'segments'],
